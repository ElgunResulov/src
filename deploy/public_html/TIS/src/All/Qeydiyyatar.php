...
<style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .xidmet-qiymet-xulase{background:#eff6ff;border:1px solid #93c5fd;border-radius:12px;padding:14px 16px;margin:12px 0 0;font-size:14px;color:#1e3a8a}
    .xidmet-qiymet-xulase ul{margin:8px 0 10px 18px;padding:0}
...
<div class="page-wrapper">
    ...
    <div class="main-content<?= $isEmbed ? ' embed-mode' : '' ?>">
        <div class="content-container">
            ...
            <div id="xidmetQiymetXulase" class="xidmet-qiymet-xulase" style="display:none">
                <strong>Seçilmiş xidmətlər üzrə hesablama</strong>
                <ul id="xidmetQiymetList"></ul>
                <div id="xidmetQiymetCemi"></div>
                <small>Qiymətlər avtomatik hesablanır. Lazım olsa təhsil haqqını əl ilə dəyişə bilərsiniz.</small>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateTehsilHaqqi() {
        ...
        if (xidmetQiymetXulase) xidmetQiymetXulase.style.display = 'block';
        if (xidmetQiymetList) {
    ...
    document.querySelectorAll('input[name="services[]"]').forEach(function(cb) {
        cb.addEventListener('change', calculateTehsilHaqqi);
    });
