...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
        ...
        .custom-schedule-container {
            ...
            border-radius: 15px;
            overflow: hidden;
            box-shadow: 0 8px 25px rgba(98, 74, 255, 0.15);
        }

        .custom-schedule-header {
            background: linear-gradient(135deg, rgba(98, 74, 255, 0.9) 0%, rgba(108, 92, 231, 0.9) 100%);
            color: white;
            padding: 20px;
            text-align: center;
            position: relative;
        ...
        .custom-schedule-header .schedule-subtitle {
            margin: 5px 0 0 0;
            opacity: 0.9;
            font-size: 0.9rem;
            position: relative;
        ...
        .custom-schedule-row:hover {
            background: rgba(98, 74, 255, 0.04);
            transform: translateX(5px);
        }

        .custom-schedule-row:last-child {
            border-bottom: none;
        }
        ...
        .custom-classroom-info {
            ...
            color: #495057;
            display: inline-block;
            border-left: 3px solid rgba(98, 74, 255, 0.5);
        }
        ...
        .custom-no-schedule i {
            font-size: 3rem;
            color: rgba(98, 74, 255, 0.3);
            margin-bottom: 15px;
            display: block;
        }
        ...
        .custom-date-input:focus {
            border-color: rgba(98, 74, 255, 0.5);
            box-shadow: 0 0 0 0.2rem rgba(98, 74, 255, 0.15);
            outline: none;
        }
        ...
        .custom-info-badge {
            background: rgba(98, 74, 255, 0.1);
            color: rgba(98, 74, 255, 0.9);
            padding: 4px 8px;
            border-radius: 8px;
            font-size: 0.75rem;
            font-weight: 500;
