    ...
    <div class="main-content main">
        <div class="filter-section">
            <select>
                ...
                <option>Tədris ili 2023-2024</option>
                <option>Tədris ili 2024-2025</option>
            </select>
            <select>
        ...
        <table class="simple-table">
            <thead>
                <tr>
                    ...
                    <th>Maks. bal</th>
                    <th>Nəticə</th>
                    <th>Son göndərilmə tarixi</th>
                    <th>Şərh</th>
                    <th>Göndərilmə tarixi</th>
                    <th>Qiymətləndirmə tarixi</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td colspan="8" class="no-data">Nəticə yoxdur.</td>
                </tr>
            </tbody>
        </table>
    </div>
